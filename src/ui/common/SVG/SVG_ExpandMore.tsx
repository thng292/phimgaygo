...
const SVG_ExpandMore: FC<{ fill?: string }> = ({fill = '#ffffff'}) => {
    return <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24"
